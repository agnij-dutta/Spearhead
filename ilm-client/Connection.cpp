// Imports provide necessary functions and definitions for networking and I/O operations.
#include <iostream>
#include <stdio.h>
#include <unistd.h>
#include <sys/types.h>
...
//Contain additional classes and functions used within the code.
...
//define C functions or variables used in the code.
extern "C" {
...
//*****************************************************************************************
extern AincradILM *myILMInstance;
 
//*****************************************************************************************

// Handles the network connection and communication.
...
// Closes the SSL connection and the socket, sets the state to NOCONNECTION, and frees any allocated resources.
Connection::~Connection()
{
...
//	close( listenfd );
	...
	//if ( ( local.sin_port < 1 ) || ( local.sin_port > 65535 ) ) // Sin_port can never be greater than 65535...
	if  ( local.sin_port < 1 ) 
	{
		state = CONNERROR;
		return ERROR;
